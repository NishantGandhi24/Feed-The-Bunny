class Rope
  {
    ...
    {
      //nlink: number of rectangles to be connected
      //pointA: x and y position where the rope should be connected
      this.nlink = nlink
  const group = Body.nextGroup(true);
  // stack: save the rectangles
  const rects = Composites.stack(100, 100, this.nlink,1, 5, 5, function(x, y) {
     ...
     // collisionFilter: used to connect groups
  });
      
  this.pointA = pointA;
  //chain: join the rectangles
